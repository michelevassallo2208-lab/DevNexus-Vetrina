...
export const translations = {
  en: {
    nav: {
      ...
      portfolio: 'Portfolio',
      contact: 'Contact',
      hire: 'Hire me on Fiverr'
    },
    hero: {
      badge: 'Available for new projects',
      title1: 'Building the Future',
      title2: 'Bit by Bit.',
      subtitle: 'I am Michele, founder of DevNexus. 27 years of passion between code and infrastructure. I combine frontend elegance with system-level solidity.',
      cta1: 'View my work',
      cta2: "Let's talk",
      stats: '50+ Successful projects delivered'
    },
    about: {
      badge: 'Who I am',
      title: 'A 360° approach to digital development.',
      text: 'I am not just a developer. My career started among Linux terminals and server racks. This dual soul allows me to create websites that are not only "beautiful to look at", but designed to be secure, lightning fast, and ready to handle millions of users.',
      ageBadge: 'Years of Energy',
    ...
    services: {
      ...
      subtitle: 'From the first line of code to production deployment on scalable cloud infrastructures.',
      items: [
        { title: 'Full-Stack Web Dev', desc: 'Performant, modern, and SEO-optimized websites to scale your business.' },
        { title: 'Systems & Cloud', desc: 'Linux server management, VPS configuration, and secure cloud infrastructures.' },
        { title: 'DevOps & Automation', desc: 'CI/CD pipelines, Dockerization, and Bash scripts to automate every process.' },
        { title: 'Security & Performance', desc: 'Server hardening and loading time optimization (Lighthouse 100).' }
      ]
    },
    portfolio: {
      badge: 'Portfolio',
      title: 'Aesthetic & Solid Engineering.',
      subtitle: 'A selection of projects demonstrating my ability to merge modern design with excellent performance.',
      viewAll: 'View all projects',
      preview: 'Live Preview'
    },
    contact: {
      title: 'Ready to launch your idea? 🚀',
      subtitle: 'Whether you need a breathtaking new website or your server is misbehaving, I am here to help. I usually respond in less than 1 hour.',
      email: 'Email',
      support: '24/7 Support',
      supportText: 'Available on Fiverr and Telegram',
      fiverrTitle: 'Looking for a reliable pro on Fiverr?',
      fiverrCta: 'Order on Fiverr',
  ...
  it: {
    nav: {
      ...
      portfolio: 'Portfolio',
      contact: 'Contatti',
      hire: 'Assumimi su Fiverr'
    },
    hero: {
      badge: 'Disponibile per nuovi progetti',
      title1: 'Costruisco il Futuro',
      title2: 'Bit dopo Bit.',
      subtitle: 'Sono Michele, fondatore di DevNexus. 27 anni di passione tra codice e infrastrutture. Unisco l\'eleganza del frontend alla solidità dei sistemi.',
      cta1: 'Guarda i miei lavori',
      cta2: 'Parliamo del tuo progetto',
      stats: '50+ Progetti consegnati con successo'
    },
    about: {
      badge: 'Chi Sono',
      title: 'Un approccio a 360° allo sviluppo digitale.',
      text: 'Non sono solo uno sviluppatore. La mia carriera è iniziata tra terminali Linux e rack di server. Questa doppia anima mi permette di creare siti web che non sono solo "belli da vedere", ma progettati per essere sicuri, velocissimi e pronti a gestire milioni di utenti.',
      ageBadge: 'Anni di Energia',
    ...
    services: {
      ...
      subtitle: 'Dalla scrittura della prima riga di codice al deploy in produzione su infrastrutture cloud scalabili.',
      items: [
        { title: 'Sviluppo Web Full-Stack', desc: 'Siti web performanti, moderni e ottimizzati SEO per scalare il tuo business.' },
        { title: 'Sistemistica & Cloud', desc: 'Gestione server Linux, configurazione VPS e infrastrutture cloud sicure.' },
        { title: 'DevOps & Automazione', desc: 'Pipeline CI/CD, Dockerizzazione e script Bash per automatizzare ogni processo.' },
        { title: 'Sicurezza & Performance', desc: 'Hardening del server e ottimizzazione tempi di caricamento (Lighthouse 100).' }
      ]
    },
    portfolio: {
      badge: 'Portfolio',
      title: 'Ingegneria Estetica & Solida.',
      subtitle: 'Una selezione di progetti che dimostrano la mia capacità di unire design moderno e performance eccellenti.',
      viewAll: 'Vedi tutti i progetti',
      preview: 'Preview Live'
    },
    contact: {
      title: 'Pronto a far decollare la tua idea? 🚀',
      subtitle: 'Sia che tu abbia bisogno di un nuovo sito web mozzafiato o che il tuo server stia facendo i capricci, sono qui per aiutarti.',
      email: 'Email',
      support: 'Supporto 24/7',
      supportText: 'Disponibile su Fiverr e Telegram',
      fiverrTitle: 'Cerchi un professionista affidabile su Fiverr?',
      fiverrCta: 'Ordina su Fiverr',
